...
- [ ] `[Nuevo]` Migrar los selects restantes al Selector propio (ficha clínica, modales de crear, filtros de Finanzas, conexión automática de Dirección): barrido gradual antes del lanzamiento.
