...
export const RUTINAS: Rutina[] = [
  ...
  {
    id: "espalda-feliz",
    nombre: "Espalda feliz",
    emoji: "🐚",
    tipo: "suave",
    categoria: "Movilidad",
    minutos: 10,
    nivel: "suave",
    descripcion: "Estiramientos suaves para una espalda que carga el día. Todo en el suelo, sin forzar.",
    pasos: [
      "Gato y vaca, 10 rondas lentas siguiendo la respiración.",
      "Postura de la niña con brazos largos, 1 minuto.",
      "Hebra de aguja: pasa un brazo bajo el otro y gira suave, 45 segundos por lado.",
      "Rodillas al pecho, meciéndote de lado a lado, 1 minuto.",
      "Torsión acostada con brazos en cruz, 1 minuto por lado.",
      "Esfinge suave, abriendo el pecho, 5 respiraciones.",
    ],
  },
  {
