...
// cerebro TDAH y TDA a construir su vida, elegidos por impacto y no por moda.
...
export const VIAS_LIBRO: Array<{ key: ViaLibro; label: string }> = [
  { key: "tdah", label: "TDAH y TDA y foco" },
...
export const LIBROS: Libro[] = [
  // ---------- TDAH y TDA y foco ----------
  {
    ...
    via: "tdah",
    emoji: "\u{1F9E0}",
    porQue: "Los dos m\u00e9dicos que llevan d\u00e9cadas estudiando el TDAH y TDA desarman el mito de que es un defecto. Explican el cerebro que corre como un Ferrari con frenos de bicicleta, y por qu\u00e9 la clave no es forzarte m\u00e1s sino aprender a manejar tus frenos. Trae la ciencia m\u00e1s nueva y, sobre todo, esperanza concreta. EL libro para entenderte sin patologizarte.",
    resumen:
    ...
    ideas: [
      "El TDAH y TDA es un rasgo con superpoderes y costos, no un defecto de car\u00e1cter.",
      ...
      "La conexi\u00f3n humana regula: el aislamiento empeora el TDAH y TDA, el v\u00ednculo lo calma.",
      "Busca tu punto justo de est\u00edmulo: ni tan aburrida que te apagues, ni tan saturada que colapses.",
    ],
    ejercicios: [
      { nombre: "Mueve el cuerpo antes de lo difícil", como: "Diez minutos de caminata, baile o escalera justo antes de sentarte a la tarea que estás evitando. El movimiento le enciende la atención al cerebro con TDAH y TDA.", cada: "diario" },
  ...
  },
  {
    ...
    via: "tdah",
    emoji: "\u{1F32B}",
    porQue: "Mat\u00e9 mira el TDAH y TDA con una compasi\u00f3n poco com\u00fan: no como una falla gen\u00e9tica a secas, sino como una historia que tambi\u00e9n se puede sanar. Une la neurociencia con la vida emocional temprana y abre una puerta distinta, m\u00e1s humana. Controversial para algunos, liberador para quien carg\u00f3 culpa durante a\u00f1os.",
    resumen:
  ...
  },
  {
    ...
    ideas: [
      "El TDAH y TDA es un problema de regulaci\u00f3n emocional tanto como de atenci\u00f3n.",
      "Los cuadrantes de energ\u00eda: no toda hora del d\u00eda sirve para todo.",
      "La motivaci\u00f3n TDAH y TDA corre con inter\u00e9s, urgencia, novedad y desaf\u00edo.",
  ...
  {
    id: "radicalguide",
    titulo: "Una gu\u00eda radical para mujeres con TDAH y TDA (A Radical Guide for Women with ADHD)",
    autor: "Sari Solden y Michelle Frank",
    via: "tdah",
    emoji: "\u{1F451}",
    porQue: "El TDAH y TDA en mujeres se ve distinto y se diagnostica tarde, despu\u00e9s de a\u00f1os de sentirse demasiado o muy poco. Este libro es para ti espec\u00edficamente: combina teor\u00eda y ejercicios para dejar de esconderte y empezar a vivir en grande, tal como eres. Menos autoayuda gen\u00e9rica, m\u00e1s permiso para ocupar tu espacio.",
    resumen:
    ...
    ideas: [
      ...
      "Las mujeres con TDAH y TDA cargan expectativas de g\u00e9nero imposibles.",
  ...
  },
  {
    ...
    via: "tdah",
    emoji: "\u{1F5C2}",
    porQue: "Organizaci\u00f3n de la casa y de la vida escrita por una mujer con TDAH y TDA que prob\u00f3 todo lo que no funciona antes de dar con lo que s\u00ed. Cero sistemas pensados para cerebros neurot\u00edpicos: ac\u00e1 los m\u00e9todos aguantan el desorden real, los d\u00edas malos y la memoria que falla. Pr\u00e1ctico, honesto y sin culpa.",
    resumen:
  ...
  },
  {
    ...
    via: "habitos",
    emoji: "🌱",
    porQue: "La versión aún más pequeña que Clear, nacida en Stanford e ideal para el TDAH y TDA: cambios tan chicos que no activan la resistencia. Fogg arma el hábito con una receta simple de anclaje y celebración, y demuestra que la emoción, no la repetición, es lo que graba una costumbre. Empezar es ridículamente fácil, y eso es justo el punto.",
    resumen:
  ...
  },
  {
    ...
    via: "habitos",
    emoji: "🎯",
    porQue: "La atención tratada como una habilidad entrenable y no como una condena. Eyal muestra que la mayoría de las distracciones nacen adentro, de una incomodidad que evitas, y da un método para reconquistar tu foco sin culpa ni apps mágicas. Súper útil para el lado digital del TDAH y TDA: las redes, el celular, la pestaña número 47.",
    resumen:
  ...
  },
  {
    ...
    via: "habitos",
    emoji: "🎋",
    porQue: "Menos pero mejor, hecho disciplina. Para el cerebro TDAH y TDA que quiere hacerlo TODO y termina disperso, este libro es el permiso para elegir poco y en serio. McKeown enseña a distinguir lo vital de lo trivial y a decir que no sin culpa, para que tu energía vaya a lo que de verdad mueve tu vida.",
    resumen:
  ...
  // ---------- Emociones ----------
  {
    ...
    via: "emociones",
    emoji: "💗",
    porQue: "La ciencia de la autocompasión, el antídoto exacto contra la culpa crónica del TDAH y TDA. Neff demuestra con investigación que tratarte con la dureza de un sargento no motiva, paraliza, y ofrece una forma más amable y más eficaz de acompañarte. El tono cero culpa de NucleoOS viene directo de este trabajo.",
    resumen:
